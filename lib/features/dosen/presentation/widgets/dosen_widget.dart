...
// 1. MODERN DOSEN CARD (Desain kartu utama dengan gradasi)
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: Center(
                    child: Text(
                      widget.dosen.name.isNotEmpty ? widget.dosen.name.substring(0, 1).toUpperCase() : '?',
...
// 2. DOSEN CARD (Desain kartu simple alternatif)
...
// 3. DOSEN EMPTY STATE (Tampilan saat data kosong/gagal)
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text('Tidak ada data dosen', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: Colors.grey[700])),
          const SizedBox(height: 8),
...
// 4. DOSEN LIST VIEW (Pembungkus list untuk halaman page)
            ...
            return ModernDosenCard(
              ...
              onTap: () {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text('Detail: ${dosen.name}'), behavior: SnackBarBehavior.floating, duration: const Duration(seconds: 2)),
                );
              },
            );
          } else {
